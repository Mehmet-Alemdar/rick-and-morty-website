...
const docsSideBar = ({ content, isSideBarOpen }) => {
  ...
  return (
    <ul className={`pb-6 pt-[30px] overflow-y-auto bg-white ${isSideBarOpen ? "fixed top-0 left-0 w-full h-full z-50" : "hidden"} md:sticky md:min-w-[235px] md:w-[235px] md:h-[calc(-60px+100vh)] md:top-0 md:block`}>
